...
# limitations under the License.
{
  ...
  'variables': {
    ...
    'starboard_platform_sources': [
      ...
      '<(DEPTH)/third_party/starboard/amlogic/shared/atomic_public.h',
      '<(DEPTH)/third_party/starboard/amlogic/shared/configuration_public.h',
      '<(DEPTH)/third_party/starboard/amlogic/shared/decode_target_get_info.cc',
      '<(DEPTH)/third_party/starboard/amlogic/shared/decode_target_internal.cc',
      '<(DEPTH)/third_party/starboard/amlogic/shared/decode_target_internal.h',
      '<(DEPTH)/third_party/starboard/amlogic/shared/decode_target_release.cc',
      '<(DEPTH)/third_party/starboard/amlogic/shared/media_is_video_supported.cc',
      '<(DEPTH)/third_party/starboard/amlogic/shared/media_is_audio_supported.cc',
      '<(DEPTH)/third_party/starboard/amlogic/shared/system_get_connection_type.cc',
      '<(DEPTH)/third_party/starboard/amlogic/shared/system_get_device_type.cc',
      '<(DEPTH)/third_party/starboard/amlogic/shared/system_get_path.cc',
      '<(DEPTH)/third_party/starboard/amlogic/shared/system_has_capability.cc',
      ...
      '<(DEPTH)/third_party/starboard/amlogic/shared/audio_sink_is_audio_sample_type_supported.cc',
