...
# limitations under the License.
{
  ...
  'variables': {
    'starboard_platform_sources': [
      '<(DEPTH)/third_party/starboard/amlogic/wayland/arm64/main.cc',
      '<(DEPTH)/third_party/starboard/amlogic/wayland/arm64/system_get_property.cc',
      '<(DEPTH)/third_party/starboard/amlogic/wayland/arm64/player_output_mode_supported.cc',
