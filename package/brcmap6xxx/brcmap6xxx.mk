...
BRCMAP6XXX_BUILD_VERSION = $(call qstrip, $(BR2_PACKAGE_BRCMAP6XXX_VERSION))
...
define BRCMAP6XXX_BUILD_CMDS
	$(TARGET_CONFIGURE_OPTS) $(MAKE) -C $(LINUX_DIR) M=$(@D)/$(BRCMAP6XXX_BUILD_VERSION) ARCH=$(KERNEL_ARCH) \
...
define BRCMAP6XXX_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -m 0666 $(@D)/$(BRCMAP6XXX_BUILD_VERSION)/dhd.ko $(BRCMAP6XXX_INSTALL_DIR)
	echo $(BRCMAP6XXX_MODULE_DIR)/dhd.ko: >> $(TARGET_DIR)/lib/modules/$(LINUX_VERSION_PROBED)/modules.dep
	$(INSTALL) -m 0666 $(@D)/$(BRCMAP6XXX_BUILD_VERSION)/bcmdhd.ko $(BRCMAP6XXX_INSTALL_DIR)
