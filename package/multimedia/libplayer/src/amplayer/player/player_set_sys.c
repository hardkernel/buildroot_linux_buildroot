...
int DisableFreeScale(display_mode mode)
{
    ...
    case DISP_MODE_480P: //480p
        ...
        if (fd_vaxis >= 0) {
            write(fd_vaxis, "0 0 0 0", strlen("0 0 0 0"));
        }
        ret = 0;
        break;
...
int disable_freescale(int cfg)
{
    ...
    char prop[16];
    if (am_getconfig("ro.vout.dualdisplay2", prop, "false")
        && strcmp(prop, "true") == 0) {
...
int disable_freescale_MBX()
{
    ...
    am_getconfig("ro.platform.has.1080scale", m1080scale, "fail");
...
int enable_freescale_MBX()
{
    ...
    switch (disp_mode) {
    case DISP_MODE_480I:
        am_getconfig("ubootenv.var.480ioutputx", vaxis_x_str, "0");
        am_getconfig("ubootenv.var.480ioutputy", vaxis_y_str, "0");
        am_getconfig("ubootenv.var.480ioutputwidth", vaxis_width_str, "720");
        am_getconfig("ubootenv.var.480ioutputheight", vaxis_height_str, "480");
        break;
    case DISP_MODE_480P:
        am_getconfig("ubootenv.var.480poutputx", vaxis_x_str, "0");
        am_getconfig("ubootenv.var.480poutputy", vaxis_y_str, "0");
        am_getconfig("ubootenv.var.480poutputwidth", vaxis_width_str, "720");
        am_getconfig("ubootenv.var.480poutputheight", vaxis_height_str, "480");
        break;
    case DISP_MODE_576I:
        am_getconfig("ubootenv.var.576ioutputx", vaxis_x_str, "0");
        am_getconfig("ubootenv.var.576ioutputy", vaxis_y_str, "0");
        am_getconfig("ubootenv.var.576ioutputwidth", vaxis_width_str, "720");
        am_getconfig("ubootenv.var.576ioutputheight", vaxis_height_str, "576");
        break;
    case DISP_MODE_576P:
        am_getconfig("ubootenv.var.576poutputx", vaxis_x_str, "0");
        am_getconfig("ubootenv.var.576poutputy", vaxis_y_str, "0");
        am_getconfig("ubootenv.var.576poutputwidth", vaxis_width_str, "720");
        am_getconfig("ubootenv.var.576poutputheight", vaxis_height_str, "576");
        break;
    case DISP_MODE_720P:
        am_getconfig("ubootenv.var.720poutputx", vaxis_x_str, "0");
        am_getconfig("ubootenv.var.720poutputy", vaxis_y_str, "0");
        am_getconfig("ubootenv.var.720poutputwidth", vaxis_width_str, "1280");
        am_getconfig("ubootenv.var.720poutputheight", vaxis_height_str, "720");
        break;
    case DISP_MODE_1080I:
        am_getconfig("ubootenv.var.1080ioutputx", vaxis_x_str, "0");
        am_getconfig("ubootenv.var.1080ioutputy", vaxis_y_str, "0");
        am_getconfig("ubootenv.var.1080ioutputwidth", vaxis_width_str, "1920");
        am_getconfig("ubootenv.var.1080ioutputheight", vaxis_height_str, "1080");
        break;
    case DISP_MODE_1080P:
        am_getconfig("ubootenv.var.1080poutputx", vaxis_x_str, "0");
        am_getconfig("ubootenv.var.1080poutputy", vaxis_y_str, "0");
        am_getconfig("ubootenv.var.1080poutputwidth", vaxis_width_str, "1920");
        am_getconfig("ubootenv.var.1080poutputheight", vaxis_height_str, "1080");
        break;
    default:
        break;
    }
...
int GL_2X_scale(int mSwitch)
{
	...
	else if(mSwitch == 1)
	{
		...
		if(!strncmp(mode, "480i", 4) || !strncmp(mode, "480p", 4))
		{
		    ...
		    {
               	am_getconfig("ubootenv.var.480ioutputx",vaxis_newx_str,"0");			  
			    am_getconfig("ubootenv.var.480ioutputy",vaxis_newy_str,"0");			  
			    am_getconfig("ubootenv.var.480ioutputwidth",vaxis_width_str,"720");			  
			    am_getconfig("ubootenv.var.480ioutputheight",vaxis_height_str,"480");
		    ...
		    {            
               	am_getconfig("ubootenv.var.480poutputx",vaxis_newx_str,"0");			  
			    am_getconfig("ubootenv.var.480poutputy",vaxis_newy_str,"0");			  
			    am_getconfig("ubootenv.var.480poutputwidth",vaxis_width_str,"720");			  
			    am_getconfig("ubootenv.var.480poutputheight",vaxis_height_str,"480");        
			}
		...
		else if(!strncmp(mode, "576i", 4) || !strncmp(mode, "576p", 4))
		{
		    ...
		    {
               	am_getconfig("ubootenv.var.576ioutputx",vaxis_newx_str,"0");			  
			    am_getconfig("ubootenv.var.576ioutputy",vaxis_newy_str,"0");			  
			    am_getconfig("ubootenv.var.576ioutputwidth",vaxis_width_str,"720");			  
			    am_getconfig("ubootenv.var.576ioutputheight",vaxis_height_str,"576");
		    ...
		    {            
               	am_getconfig("ubootenv.var.576poutputx",vaxis_newx_str,"0");			  
			    am_getconfig("ubootenv.var.576poutputy",vaxis_newy_str,"0");			  
			    am_getconfig("ubootenv.var.576poutputwidth",vaxis_width_str,"720");			  
			    am_getconfig("ubootenv.var.576poutputheight",vaxis_height_str,"576");        
			}
		...
		{
        	am_getconfig("ubootenv.var.720poutputx",vaxis_newx_str,"0");			  
			am_getconfig("ubootenv.var.720poutputy",vaxis_newy_str,"0");			  
			am_getconfig("ubootenv.var.720poutputwidth",vaxis_width_str,"1280"); 		  
			am_getconfig("ubootenv.var.720poutputheight",vaxis_height_str,"720");
		...
		else if(!strncmp(mode, "1080i", 5) || !strncmp(mode, "1080p", 5))
		{
		    ...
		    {
               	am_getconfig("ubootenv.var.1080ioutputx",vaxis_newx_str,"0");			  
			    am_getconfig("ubootenv.var.1080ioutputy",vaxis_newy_str,"0");			  
			    am_getconfig("ubootenv.var.1080ioutputwidth",vaxis_width_str,"1920");			  
			    am_getconfig("ubootenv.var.1080ioutputheight",vaxis_height_str,"1080");
		    ...
		    {            
               	am_getconfig("ubootenv.var.1080poutputx",vaxis_newx_str,"0");			  
			    am_getconfig("ubootenv.var.1080poutputy",vaxis_newy_str,"0");			  
			    am_getconfig("ubootenv.var.1080poutputwidth",vaxis_width_str,"1920");			  
			    am_getconfig("ubootenv.var.1080poutputheight",vaxis_height_str,"1080");        
			}
