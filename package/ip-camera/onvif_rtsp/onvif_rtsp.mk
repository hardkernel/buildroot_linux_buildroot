...
ONVIF_RTSP_DEPENDENCIES = gst1-plugins-base gst1-plugins-good gst1-rtsp-server gstreamer1
ONVIF_RTSP_DEPENDENCIES += gst-plugin-amlvenc gst-plugin-amloverlay gst-plugin-amlimgcap gst-plugin-amlyoloface
