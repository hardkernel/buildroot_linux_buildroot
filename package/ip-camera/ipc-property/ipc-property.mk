...
define IPC_PROPERTY_PREPARE_JSON_LIB
	mkdir -p $(@D)/json
	$(INSTALL) -D -m 644 $(DL_DIR)/json.hpp $(@D)/json/
endef
...
define IPC_PROPERTY_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -D -m 755 $(IPC_PROPERTY_PKGDIR)/S80ipc-property-service $(TARGET_DIR)/etc/init.d/
	$(INSTALL) -D -m 755 $(IPC_PROPERTY_PKGDIR)/ipc.json $(TARGET_DIR)/etc/
endef
