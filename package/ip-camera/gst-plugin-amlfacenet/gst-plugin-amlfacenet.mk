...
GST_PLUGIN_AMLFACENET_LICENSE_FILES = COPYING

define GST_PLUGIN_AMLFACENET_SYNC_COMMON_SRC
	rsync -avz $(GST_PLUGIN_AMLFACENET_SITE)/../common/ $(@D)/src/
endef
GST_PLUGIN_AMLFACENET_POST_RSYNC_HOOKS += GST_PLUGIN_AMLFACENET_SYNC_COMMON_SRC
