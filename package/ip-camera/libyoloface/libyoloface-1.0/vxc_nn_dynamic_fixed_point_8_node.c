...
/* Load a tensor from the resource file */
vx_tensor vxcLoadTensor2(vx_context context, vx_uint32 num_of_dim, vx_uint32 x, vx_uint32 y, vx_uint32 z, vx_uint32 w,
        tensor_format_info_t* tfi, vx_uint32 blob_offset, vx_uint32 blob_size, vx_uint32 blob_uint_size)
{
    return vxcLoadTensor(context, num_of_dim, x, y, z, w, tfi, data_file, blob_offset, blob_size, blob_uint_size);
}
