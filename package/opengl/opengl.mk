...
OPENGL_SITE=.
OPENGL_VERSION=
ifneq ($(BR2_PACKAGE_GPU_VERSION),)
OPENGL_VERSION=$(BR2_PACKAGE_GPU_VERSION)
else
OPENGL_VERSION=$(BR2_PACKAGE_OPENGL_VERSION)
endif

ifeq ($(OPENGL_VERSION),"r3p2")
MALI_LIB_LOC=r3p2-EAC
else ifeq ($(OPENGL_VERSION),"r4p0-01")
  ifeq ($(BR2_PACKAGE_OPENGL_MALI_VERSION),"MALI400")
  MALI_LIB_LOC=r4p0-01/m400
  else ifeq ($(BR2_PACKAGE_OPENGL_MALI_VERSION),"MALI400-X")
  MALI_LIB_LOC=r4p0-01/m400-X
  else ifeq ($(BR2_PACKAGE_OPENGL_MALI_VERSION),"MALI450")
  MALI_LIB_LOC=r4p0-01/m450
  else ifeq ($(BR2_PACKAGE_OPENGL_MALI_VERSION),"MALI450-X")
  MALI_LIB_LOC=r4p0-01/m450-X
  endif
else ifeq ($(OPENGL_VERSION),"r4p1")
  ifeq ($(BR2_PACKAGE_OPENGL_MALI_VERSION),"MALI400")
  MALI_LIB_LOC=r4p1/m400
  else ifeq ($(BR2_PACKAGE_OPENGL_MALI_VERSION),"MALI400-X")
  MALI_LIB_LOC=r4p1/m400-X
  else ifeq ($(BR2_PACKAGE_OPENGL_MALI_VERSION),"MALI450")
  MALI_LIB_LOC=r4p1/m450
  else ifeq ($(BR2_PACKAGE_OPENGL_MALI_VERSION),"MALI450-X")
  MALI_LIB_LOC=r4p1/m450-X
  endif
else ifeq ($(OPENGL_VERSION),"r5p0")
  ifeq ($(BR2_PACKAGE_OPENGL_MALI_VERSION),"MALI400")
  MALI_LIB_LOC=r5p0/m400
  else ifeq ($(BR2_PACKAGE_OPENGL_MALI_VERSION),"MALI400-X")
  MALI_LIB_LOC=r5p0/m400-X
  else ifeq ($(BR2_PACKAGE_OPENGL_MALI_VERSION),"MALI450")
  MALI_LIB_LOC=r5p0/m450
  else ifeq ($(BR2_PACKAGE_OPENGL_MALI_VERSION),"MALI450-X")
  MALI_LIB_LOC=r5p0/m450-X
  endif
endif
