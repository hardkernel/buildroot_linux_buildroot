...
WESTEROS_SINK_VERSION = 8904a11d560f0de0fbe855b4fc604c367d0c0645 
...
ifeq ($(BR2_PACKAGE_RPI_USERLAND),y)
	...
	WESTEROS_SINK_DEPENDENCIES += gstreamer1
	WESTEROS_SINK_CONF_OPTS += --enable-gstreamer1=yes \
				CFLAGS="$(TARGET_CFLAGS) -I${STAGING_DIR}/usr/include/libdrm -x c++"\
				CXXFLAGS="$(TARGET_CXXFLAGS) -I${STAGING_DIR}/usr/include/libdrm "
	WESTEROS_SINK_MAKE_ENV += PKG_CONFIG_SYSROOT_DIR=${STAGING_DIR} 
