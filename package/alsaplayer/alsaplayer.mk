...
ALSAPLAYER_CONF_OPTS = --enable-esd=no \
					   --enable-oss=no \
					   --with-ogg-prefix=${TARGET_OUTPUT_DIR}/host/usr/aarch64-buildroot-linux-gnu/sysroot/usr/lib \
					   --with-vorbis-prefix=${TARGET_OUTPUT_DIR}host/usr/aarch64-buildroot-linux-gnu/sysroot/usr/lib
