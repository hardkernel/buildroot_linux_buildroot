...
#	$(AML_CYPRESS_BSA_BTHID_DRIVER_TARGET_CMDS)
	...
	$(INSTALL) -D -m 755 package/aml_cypress_bsa/S44bluetooth $(TARGET_DIR)/etc/init.d
	$(INSTALL) -D -m 755 package/aml_cypress_bsa/$(BT_AUDIO_CONF) $(TARGET_DIR)/etc/alsa_bsa.conf
endef
