...
ifeq ($(BR2_PACKAGE_RTK8723BU_LOCAL),y)
RTK8723BU_SITE = $(call qstrip,$(BR2_PACKAGE_RTK8723BU_LOCAL_PATH))
RTK8723BU_SITE_METHOD = local
endif
...
define RTK8723BU_BUILD_CMDS
	$(TARGET_CONFIGURE_OPTS) $(MAKE1) -C $(LINUX_DIR) M=$(@D)/rtl8723BU ARCH=$(KERNEL_ARCH) \
		CONFIG_RTL8723BU=m CROSS_COMPILE=$(TARGET_KERNEL_CROSS) modules
endef
