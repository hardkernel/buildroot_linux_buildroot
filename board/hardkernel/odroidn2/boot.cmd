...
setenv bootargs "root=/dev/mmcblk0p2 rootfstype=ext4 rootwait init=/sbin/init console=ttyS0,115200 no_console_suspend earlyprintk=aml-uart,0xff803000 ramoops.pstore_en=1 ramoops.record_size=0x8000 ramoops.console_size=0x4000 voutmode=${voutmode} hdmimode=${hdmimode} cvbsmode=${cvbsmode} vdaccfg=${vdac_config}"
